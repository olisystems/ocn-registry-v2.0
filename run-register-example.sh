...
yarn cli set-party -c BR CPO -r CPO  -s 379a602e6068f313de54bf118d38071b22ed15caf854d1050c3fed455ab75f50 -o 0xB43253229b9d16cE16e9c836B472D84269338808  -n $NETWORK  --name 'local cpo example' --url http://cpo.example.com 
yarn cli set-party -c BR EMP -r EMSP  -s 2881dee3e96e383a222c39687dee395d5ba70965fd9caa7a1d686c4d78adc93d -o 0xB43253229b9d16cE16e9c836B472D84269338808  -n $NETWORK  --name 'local emp example' --url http://emp.example.com 
